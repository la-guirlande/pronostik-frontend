...
export const Sidebar: FC = () => {
    return (
        ...
        <div className="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between">
          <a href="#" className="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-sm dark-mode:text-white focus:outline-none focus:shadow-outline">Pronostik</a>
        ...
        <nav className="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
          ...
          <a className="block px-4 py-2 mt-2 text-sm font-semibold font-montserrat text-gray-900 bg-transparent rounded-sm dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">Jouer</a>
          <a className="block px-4 py-2 mt-2 text-sm font-semibold font-montserrat text-gray-900 bg-transparent rounded-sm dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">Compte</a>
