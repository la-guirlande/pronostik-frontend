...
export const GameCard: FC<GameCardProps> = ({ game, onClick }) => {
    ...
    return (<div className="mx-6 bg-gray-100 flex justify-center items-center">
            ...
            <div className="text-center relative py-14">
                ...
                <h1 className="mb-1 text-2xl font-sans font-semibold text-gray-700 hover:text-gray-900 cursor-pointer">{game.name}</h1>
                <span className="text-lg text-gray-700 hover:text-gray-900">{game.description}</span>
            </div>
            </div>
        </div>);
}
